<p>
  Jeason chen built the xiaoMiquanWrite app as a freemium app. This SERVICE is
  provided by Jeason chen at no cost and is intended for use as is.
</p>
<p>
...
<p>
  ...
  and Conditions, which is accessible at xiaoMiquanWrite, unless otherwise
...
<p>
  ...
  to users name, e-mail. The information that I request is used as described in
  this privacy policy.
</p>
<p>
...
<p>
  ...
  version, configuration of the app when utilising my Service, the time and date
